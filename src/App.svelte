  ...
  <div class="card-showcase">
    ...
    <MtgCard
      ...
      loyaltyAbilities={[
        {
          cost: "+1",
          text: "Reveal the top two cards of your library. An opponent chooses one. Put that card into your hand and the other into exile with a silver counter on it.",
        },
  ...
  <div class="card-showcase">
    ...
    <MtgCard
      ...
      chapters={[
        {
          numerals: "I",
          text: "Look at the top five cards of your library. You may reveal up to two artifact cards. Put them into your hand and the rest on the bottom.",
        },
